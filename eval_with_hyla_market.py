...
def run_evaluation(checkpoint_path, output_file='submission.json', device='cuda', args=None):
    ...
    for idx in tqdm(range(total_tasks), desc="Evaluating"):
        ...
        try:
            ...
            for test_idx, test_input in enumerate(test_inputs):
                ...
                if args.alpha_evolve:
                    ...
                    evolver = AlphaEvolver(model, dsl_ops=DSL_OPS, device=device, cfg=cfg)
